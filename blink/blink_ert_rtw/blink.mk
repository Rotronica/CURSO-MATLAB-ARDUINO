###########################################################################
## Makefile generated for component 'blink'. 
## 
## Makefile     : blink.mk
## Generated on : Sat Mar 15 23:38:54 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/blink.elf
...
START_DIR                 = E:/arduino_simulink/blink
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/blink.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=1 -DMW_PRESCALAR=1024 -DMW_TIMERCOUNT=49911 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=blink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o blink.o blink_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/blink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/blink_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
blink.o : $(START_DIR)/blink_ert_rtw/blink.c
	$(CC) $(CFLAGS) -o "$@" "$<"


blink_data.o : $(START_DIR)/blink_ert_rtw/blink_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/blink_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
