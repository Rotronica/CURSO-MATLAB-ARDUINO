...
## 
## Makefile     : adc.mk
## Generated on : Wed Mar 19 22:14:15 2025
...
START_DIR                 = E:/arduino_simulink/adc
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
DEFINES_STANDARD = -DMODEL=adc -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o xcp_ext_mode.o adc.o adc_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
adc.o : $(START_DIR)/adc_ert_rtw/adc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


adc_data.o : $(START_DIR)/adc_ert_rtw/adc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/adc_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
